...
class S1ManajemenDetailPage extends StatefulWidget {
  final String title;

  S1ManajemenDetailPage(this.title);

  @override
  _S1ManajemensDetailPageState createState() =>
      _S1ManajemensDetailPageState();
}

class _S1ManajemensDetailPageState extends State<S1ManajemenDetailPage> {
      ...
      child: ExpansionTile(
        ...
        children: [
          ...
          Padding(
            ...
            child: Text(
              'Program Studi S1 Manajemen didirikan pada bulan Maret 1966 di bawah Fakultas Ekonomi (kemudian Fakultas Ekonomi dan Bisnis) dan menjadi salah satu program studi paling dicari di UPNVJT, menarik sejumlah besar siswa setiap tahun. Program ini secara teratur diakreditasi oleh BAN-PT dengan status "A". Beberapa peningkatan yang dilakukan oleh program ini antara lain merekrut lebih banyak dosen dengan gelar Master dan Doktor, menambahkan pilihan kursus konsentrasi, dan memperbarui kurikulum dengan pendekatan multidisiplin dan kursus perilaku. Program Manajemen juga telah mengadaptasi kebijakan "Kampus Merdeka, Kebebasan Belajar" pada tahun 2020, memungkinkan siswa mengejar minatnya di luar program utama dan melakukan program magang internasional.',
                  ...
                  children: [
                    ...
                    Text(
                      ...
                      style: TextStyle(
                        fontWeight: FontWeight.bold,
                        fontSize: 18,
                        color: Color.fromARGB(255, 4, 22, 18),
                      ),
                    ),
                    Text(
            ...
            Column(
              ...
              children: [
                ...
                GridView.count(
                  ...
                  children: [
                    _buildGridItem('mn1.png', 'Dewi Khrisna Sawitri, S.S, S.Psi. M.Si'),
                    _buildGridItem('mn2.png', 'Dr. Endang Sholihatin, S.Pd, M.Pd'),
                    _buildGridItem('mn3.png', 'Dra.Ec. Kustini, M. Si, CHRA.'),
                    _buildGridItem('mn4.png', 'Ira Wikartika SE,MM'),
                    _buildGridItem('mn5.png', 'Prof. Dr. Ir. Akhmad Fauzi, MMT, CHRA\n'),
                  ],
                ),
              ],
            ),
 ...
 Padding(
   ...
   child: Column(
     ...
     children: [
       ...
       SizedBox(height: 8), // Spasi antara judul dan deskripsi
       Text(
         'Idrak Alif Miftahul Haqqi (Manajemen, 2021)',
         style: TextStyle(fontSize: 16, fontWeight: FontWeight.bold),
       ),
       Text(
         'Juara 2 Mobile Legends Telkom University E-Sport Championship 2022',
         style: TextStyle(fontSize: 16),
         textAlign: TextAlign.justify,
       ),
     ],
